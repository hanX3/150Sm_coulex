void compare_draw()
{
  ...
  vector<string> v_filename = {
    "try/025ns/rootfile/data0616_0674_doppler_25ns_jump_300ns_hist.root",
    "try/050ns/rootfile/data0616_0674_doppler_50ns_jump_300ns_hist.root",
    "try/100ns/rootfile/data0616_0674_doppler_100ns_jump_300ns_hist.root",
    "try/150ns/rootfile/data0616_0674_doppler_150ns_jump_300ns_hist.root",
    "try/200ns/rootfile/data0616_0674_doppler_200ns_jump_300ns_hist.root",
    "try/250ns/rootfile/data0616_0674_doppler_250ns_jump_300ns_hist.root",
    "try/300ns/rootfile/data0616_0674_doppler_300ns_jump_300ns_hist.root"
  };
  ...
  for(auto &[key,val] : m_ge_rs_good){
    ...
    for(int i=0;i<n_files;++i){
      cout << "!!! " << nn*i+krs << endl;
      leg_grs_spa[krs]->AddEntry(v_h_grs_spa[nn*i+krs], v_filename[i].substr(4,5).c_str());
