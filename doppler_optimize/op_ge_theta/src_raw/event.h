...
// Fri May 16 10:03:30 2025 by ROOT version 6.24/02
// from TTree tr_event/timewindow_200
// found on file: ../rootfile/data0550_build_200ns.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           n_ge;
   Short_t         ge_sid[8];   //[n_ge]
   Short_t         ge_ch[8];   //[n_ge]
   Short_t         ge_ring_id[8];   //[n_ge]
   Short_t         ge_sector_id[8];   //[n_ge]
   Double_t        ge_energy[8];   //[n_ge]
   Long64_t        ge_ts[8];   //[n_ge]
   Int_t           n_spider;
   Short_t         spider_sid[7];   //[n_spider]
   Short_t         spider_ch[7];   //[n_spider]
   Short_t         spider_ring_id[7];   //[n_spider]
   Short_t         spider_sector_id[7];   //[n_spider]
   Double_t        spider_energy[7];   //[n_spider]
   Long64_t        spider_ts[7];   //[n_spider]
   Int_t           n_s3_sector;
   Short_t         s3_sector_sid[7];   //[n_s3_sector]
   Short_t         s3_sector_ch[7];   //[n_s3_sector]
   Short_t         s3_sector_id[7];   //[n_s3_sector]
   Double_t        s3_sector_energy[7];   //[n_s3_sector]
   Long64_t        s3_sector_ts[7];   //[n_s3_sector]
   Int_t           n_s3_ring;
   Short_t         s3_ring_sid[7];   //[n_s3_ring]
   Short_t         s3_ring_ch[7];   //[n_s3_ring]
   Short_t         s3_ring_id[7];   //[n_s3_ring]
   Double_t        s3_ring_energy[7];   //[n_s3_ring]
   Long64_t        s3_ring_ts[7];   //[n_s3_ring]
