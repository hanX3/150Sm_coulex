...
void eff_cali_ring_ge(int r);
void get_ring_ge_h(int r);
double eff_cali_ring_ge_single_peak(TH1D *h, double energy, double l_bg, double l_peak, double u_peak, double u_bg, double ll_ex, double lr_ex, double hl_ex, double hr_ex);
...
double *eff_fit(map<double, double> &m,  map<double, double> &m_err)
{
  ...
  */
  ...
  cc->Update();
  cc->SaveAs(Form("./fig/ring%02d_eff.png",ring));
...
void eff_cali_ring_ge(int r)
{
  ...
  */
  ...
  for(auto it=m_133Ba.begin();it!=m_133Ba.end();it++){
    ...
    sum = eff_cali_ring_ge_single_peak(h, e, l_bg, l_peak, u_peak, u_bg, ll_ex, lr_ex, hl_ex, hr_ex);
...
void get_ring_ge_h(int r)
{
  ...
  if(r==3){
    cout << "ring == 3" << endl;
    cut_ge = "(ge_ring_id==3&&ge_sector_id==2) || (ge_ring_id==3&&ge_sector_id==3) || (ge_ring_id==3&&ge_sector_id==4) || (ge_ring_id==3&&ge_sector_id==8) || (ge_ring_id==3&&ge_sector_id==9) || (ge_ring_id==3&&ge_sector_id==10)";
    tr->Draw("ge_energy>>h", cut_ge, "goff");  
  }else if(r==4){
    cout << "ring == 4" << endl;
    cut_ge = "(ge_ring_id==4&&ge_sector_id==1) || (ge_ring_id==4&&ge_sector_id==2) || (ge_ring_id==4&&ge_sector_id==3) || (ge_ring_id==4&&ge_sector_id==4) || (ge_ring_id==4&&ge_sector_id==5) || (ge_ring_id==4&&ge_sector_id==6) || (ge_ring_id==4&&ge_sector_id==7) || (ge_ring_id==4&&ge_sector_id==8)";
    tr->Draw("ge_energy>>h", cut_ge, "goff");
  }else if(r==5){
    cout << "ring == 5" << endl;
    cut_ge = "(ge_ring_id==5&&ge_sector_id==2) || (ge_ring_id==5&&ge_sector_id==3) || (ge_ring_id==5&&ge_sector_id==4) || (ge_ring_id==5&&ge_sector_id==5) || (ge_ring_id==5&&ge_sector_id==6)";
    tr->Draw("ge_energy>>h", cut_ge, "goff");
  }else{
    cout << "wrong ring number" << endl;
    return;
  }
}
